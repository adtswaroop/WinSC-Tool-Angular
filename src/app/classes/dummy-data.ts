...
export class DummyData {
  ...
  public w3 =new WinCondition(['Alavaro','Kam'],[],1,'Romi',5,5,this.categoryArray3,
  ...
  public w5 =new WinCondition(['Alavaro','Kam', 'Romi' , 'Alp'],['Kam'], 0, 'Yicheng',2,5,this.categoryArray3,
