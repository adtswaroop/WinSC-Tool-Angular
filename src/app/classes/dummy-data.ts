...
export class DummyData {
  ...
  //third win condition
  public w3c1 = new Comment(['Aditi', 'Alex'], [], -5, 'Kam', 1, 5, ['win-win page'],
                          'This should be user specific', 100, false);
  public w3c2 = new Comment(['Kam', 'Romi'], [], 8, 'Doruk', 1, 5, ['win-win page'],
                          'We should only let the facilitator do it', 100, false);
  public w3c3 = new Comment(['Kam'], [], 8, 'Kam', 1, 5, ['win-win page'],
                    'I agree', 100, false);

  public w3 =new WinCondition(['Alavaro','Kam'],[],7,'Romi',5,5,['win-win page'],
                  "As an owner, I can delete/hide a project from the project settings page",
                  [this.w3c1,this.w3c2,this.w3c3]);
				  

  //fourth win condition
  public w4c1 = new Comment(['Kam', 'Alex' , 'Yiechen'], [], -5, 'Alp', 1, 5, ['project list'],
                          'How do we decide who is the admin', 100, false);
  public w4c2 = new Comment(['Kam', 'Romi'], ['Aditi'], 8, 'Doruk', 1, 5, ['project list'],
                          'Only the owner should be able to do it', 100, false);
  public w4c3 = new Comment(['Kam'], [], 8, 'Alp', 1, 5, ['project list'],
                    'May be we can flag it and the owner can delete it themseleves if they are flagged', 100, false);
  public w4c4 = new Comment(['Alp'], [], 8, 'Kam', 1, 5, ['project list'],
                    'This sounds good', 100, false);


  public w4 =new WinCondition(['Alavaro','Kam'],['Aditi' , 'Doruk'],-2,'Romi',5,5,['project list'],
                  "As an admin, I can edit and delete everyone's posts and comments.",
                  [this.w4c1,this.w4c2,this.w4c3, this.w4c4]);
	

  //fifth win condition
  public w5c1 = new Comment(['Kam', 'Alex' , 'Yiechen'], ['Romi', 'Doruk'], -1, 'Aditi', 1, 5, ['project list'],
                          'Which part of a project can be made pbulic?', 100, false);


  public w5 =new WinCondition(['Alavaro','Kam', 'Romi' , 'Alp'],['Kam'], 2, 'Yeichen',2,5,['project list'],
